...
gfdl_low_reanal$rain_mm <- gfdl_low_raw$rain_mm + diff_gfdl_low
gfdl_high_reanal$rain_mm <- gfdl_high_raw$rain_mm + diff_gfdl_high
ukesm_low_reanal$rain_mm <- ukesm_low_raw$rain_mm + diff_ukesm_low
ukesm_high_reanal$rain_mm <- ukesm_high_raw$rain_mm + diff_ukesm_high
