#######################################
# Script: p_Create_future_weather_files.R
# Author: Ellen Maas
# Date: 12/7/2022
...
# 12/12/2022: Converted from 1_Create_weather_input_files-future_setup2.R to
#             function.
#######################################

p_Create_future_weather_files <- function(clim_scenario_num,latitude,longitude,
                                          experiment_end_year) {
  
  print("Starting p_Create_future_weather_files")
